...
from vector import Tuple, Matrix, Canvas, Color, vector, point, xf_translate, xf_scale, Ray, Sphere, Intersection, Intersections

class DadsTest(unittest.TestCase):

	def assertApproxMatrixEquals(self, m1, m2):
		return 1
#		self.assertEqual(matrix_to_string(m1, 5), matrix_to_string(m2, 5))
